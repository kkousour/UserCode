...
crabSubmitFile= open("SubmitCrabJobs.sh","w")
...
for ss in SAMPLES:
  ...
  file.write("config.Data.outLFNDirBase = \'/store/group/cmst3/group/top/gpaspala/analysis_2017/Boosted_ttHTreeProduction\'\n")
